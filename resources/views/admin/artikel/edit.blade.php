                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form method="POST" action="{{ url('/') }}/admin/artikel/update/{{ $artikel->id }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="my-3">
                                    ...
                                    <div class="my-3">
                                        ...
                                        <img style="height: 100px" src="{{ url('/') }}/images/artikel/{{ $artikel->gambar }}">
                                        <input type="file" name="gambar" class="form-control">
                                    </div>
                                    <div class="my-3">
                                        <label for="basiInput" class="form-label">Isi</label>
                                        <textarea name="isi" id="ckeditor" class="ckeditor form-control" cols="30" rows="10" required>{{ $artikel->description }}</textarea>
                                    </div>
                                    <div class="my-3">
